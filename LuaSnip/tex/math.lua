...
return {
    ...
    -- Mathbb
    s({ trig = "AA", name = "A mathbb", wordTrig = true }, t("\\mathbb{A}"), { condition = in_math }),
    s({ trig = "BB", name = "B mathbb", wordTrig = true }, t("\\mathbb{B}"), { condition = in_math }),
    s({ trig = "CC", name = "C mathbb", wordTrig = true }, t("\\mathbb{C}"), { condition = in_math }),
    s({ trig = "DD", name = "D mathbb", wordTrig = true }, t("\\mathbb{D}"), { condition = in_math }),
    s({ trig = "EE", name = "E mathbb", wordTrig = true, snippetType = "autosnippet" }, t("\\E"), { condition = in_math }),
    s({ trig = "FF", name = "F mathbb", wordTrig = true }, t("\\mathbb{F}"), { condition = in_math }),
    s({ trig = "GG", name = "G mathbb", wordTrig = true }, t("\\mathbb{G}"), { condition = in_math }),
    s({ trig = "HH", name = "H mathbb", wordTrig = true }, t("\\mathbb{H}"), { condition = in_math }),
    s({ trig = "II", name = "I mathbb", wordTrig = true }, t("\\mathbb{I}"), { condition = in_math }),
    s({ trig = "JJ", name = "J mathbb", wordTrig = true }, t("\\mathbb{J}"), { condition = in_math }),
    s({ trig = "KK", name = "K mathbb", wordTrig = true }, t("\\mathbb{K}"), { condition = in_math }),
    s({ trig = "LL", name = "L mathbb", wordTrig = true }, t("\\mathbb{L}"), { condition = in_math }),
    s({ trig = "MM", name = "M mathbb", wordTrig = true }, t("\\mathbb{M}"), { condition = in_math }),
    s({ trig = "NN", name = "N mathbb", wordTrig = true }, t("\\mathbb{N}"), { condition = in_math }),
    s({ trig = "OO", name = "O mathbb", wordTrig = true }, t("\\mathbb{O}"), { condition = in_math }),
    ...
    s({ trig = "SS", name = "S mathbb", wordTrig = true }, t("\\mathbb{S}"), { condition = in_math }),
    s({ trig = "TT", name = "T mathbb", wordTrig = true }, t("\\mathbb{T}"), { condition = in_math }),
    s({ trig = "UU", name = "U mathbb", wordTrig = true }, t("\\mathbb{U}"), { condition = in_math }),
    s({ trig = "VV", name = "V mathbb", wordTrig = true }, t("\\mathbb{V}"), { condition = in_math }),
    s({ trig = "WW", name = "W mathbb", wordTrig = true }, t("\\mathbb{W}"), { condition = in_math }),
    s({ trig = "XX", name = "X mathbb", wordTrig = true }, t("\\mathbb{X}"), { condition = in_math }),
    s({ trig = "YY", name = "Y mathbb", wordTrig = true }, t("\\mathbb{Y}"), { condition = in_math }),
    s({ trig = "ZZ", name = "Z mathbb", wordTrig = true }, t("\\mathbb{Z}"), { condition = in_math }),

    -- Mathcal
    s({ trig = "aa", name = "A mathcal", wordTrig = true, snippetType = "autosnippet" }, t("\\mathcal{A}"), { condition = in_math }),
    s({ trig = "bb", name = "B mathcal", wordTrig = true }, t("\\mathcal{B}"), { condition = in_math }),
    s({ trig = "cc", name = "C mathcal", wordTrig = true }, t("\\mathcal{C}"), { condition = in_math }),
    s({ trig = "dd", name = "D mathcal", wordTrig = true, snippetType = "autosnippet" }, t("\\mathcal{D}"), { condition = in_math }),
    s({ trig = "ee", name = "E mathcal", wordTrig = true }, t("\\mathcal{E}"), { condition = in_math }),
    s({ trig = "ff", name = "F mathcal", wordTrig = true }, t("\\mathcal{F}"), { condition = in_math }),
    s({ trig = "gg", name = "G mathcal", wordTrig = true }, t("\\mathcal{G}"), { condition = in_math }),
    s({ trig = "hh", name = "H mathcal", wordTrig = true }, t("\\mathcal{H}"), { condition = in_math }),
    s({ trig = "ii", name = "I mathcal", wordTrig = true }, t("\\mathcal{I}"), { condition = in_math }),
    s({ trig = "jj", name = "J mathcal", wordTrig = true }, t("\\mathcal{J}"), { condition = in_math }),
    s({ trig = "kk", name = "K mathcal", wordTrig = true }, t("\\mathcal{K}"), { condition = in_math }),
    s({ trig = "ll", name = "L mathcal", wordTrig = true }, t("\\mathcal{L}"), { condition = in_math }),
    s({ trig = "mm", name = "M mathcal", wordTrig = true }, t("\\mathcal{M}"), { condition = in_math }),
    s({ trig = "nn", name = "N mathcal", wordTrig = true }, t("\\mathcal{N}"), { condition = in_math }),
    ...
    s({ trig = "rr", name = "R mathcal", wordTrig = true }, t("\\mathcal{R}"), { condition = in_math }),
    s({ trig = "ss", name = "S mathcal", wordTrig = true }, t("\\mathcal{S}"), { condition = in_math }),
    s({ trig = "tt", name = "T mathcal", wordTrig = true }, t("\\mathcal{T}"), { condition = in_math }),
    s({ trig = "uu", name = "U mathcal", wordTrig = true }, t("\\mathcal{U}"), { condition = in_math }),
    s({ trig = "vv", name = "V mathcal", wordTrig = true }, t("\\mathcal{V}"), { condition = in_math }),
    s({ trig = "ww", name = "W mathcal", wordTrig = true }, t("\\mathcal{W}"), { condition = in_math }),
    ...
    s({ trig = "zz", name = "Z mathcal", wordTrig = true }, t("\\mathcal{Z}"), { condition = in_math }),
    -- stylua: ignore end
